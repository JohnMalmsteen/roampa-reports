...
<body>
	...
	<div class="explorer">
		...
		<div class="view ui-widget ui-widget-content ui-helper-clearfix ui-corner-all">
			...
			<div class="view-fields">
				<ul class="droppable ui-sortable">
					<li name="users_events@id" class="ui-state-default ui-sortable-handle">
						id
						<input type="text" class="input-int text-field-name" name="users_events@id@input-int">
					</li>
					<li name="users_events@title" class="ui-state-default ui-sortable-handle">
						title
						<input type="text" class="input-varchar text-field-name" name="users_events@title@input-varchar">
					</li>
					<li name="users_events@tracker" class="ui-state-default ui-sortable-handle">
						tracker
						<input type="text" class="input-single-char text-field-name" name="users_events@tracker@input-single-char">
					</li>
					<li name="users_events@start" class="ui-state-default ui-sortable-handle">
						start
						<div class="sup-text-field-name">
							Start Date
						</div>
						<input type="text" class="input-startdate text-field-name datepicker" name="users_events@start@input-startdate" id="dp1458984901558">
							<div class="sup-text-field-name">
								End Date
							</div>
							<input type="text" class="input-enddate text-field-name datepicker" name="users_events@start@input-enddate" id="dp1458984901559">
					</li>
					<li name="users_events@end" class="ui-state-default ui-sortable-handle">
						end
						<div class="sup-text-field-name">
							Start Date
						</div>
						<input type="text" class="input-startdate text-field-name datepicker" name="users_events@end@input-startdate" id="dp1458984901560">
							<div class="sup-text-field-name">End Date </div>
							<input type="text" class="input-enddate text-field-name datepicker" name="users_events@end@input-enddate" id="dp1458984901561">
						</li>
						<li name="users_events@userid" class="ui-state-default ui-sortable-handle">
							userid
							<input type="text" class="input-int text-field-name" name="users_events@userid@input-int">
						</li>
						<li name="users_events@firstname" class="ui-state-default ui-sortable-handle">
							firstname
							<input type="text" class="input-varchar text-field-name" name="users_events@firstname@input-varchar">
						</li>
						<li name="users_events@lastname" class="ui-state-default ui-sortable-handle">
							lastname
							<input type="text" class="input-varchar text-field-name" name="users_events@lastname@input-varchar">
						</li>
						<li name="users_events@dateofbirth" class="ui-state-default ui-sortable-handle">
							dateofbirth
							<div class="sup-text-field-name">Start Date </div>
							<input type="text" class="input-startdate text-field-name datepicker" name="users_events@dateofbirth@input-startdate" id="dp1458984901562">
								<div class="sup-text-field-name">
									End Date
								</div>
								<input type="text" class="input-enddate text-field-name datepicker" name="users_events@dateofbirth@input-enddate" id="dp1458984901563">
							</li>
							<li name="users_events@email" class="ui-state-default ui-sortable-handle">
								email
								<input type="text" class="input-varchar text-field-name" name="users_events@email@input-varchar">
							</li>
							<li name="users_events@companyid" class="ui-state-default ui-sortable-handle">
								companyid
								<input type="text" class="input-int text-field-name" name="users_events@companyid@input-int">
							</li>
							<li name="users_events@phonenumber" class="ui-state-default ui-sortable-handle">
								phonenumber
								<input type="text" class="input-varchar text-field-name" name="users_events@phonenumber@input-varchar">
							</li>
						</ul>
					</div>
				</div>
