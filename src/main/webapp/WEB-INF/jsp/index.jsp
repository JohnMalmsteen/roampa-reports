...
<body>
	...
	<div class="explorer"> <!--<?php get_table_columns(); ?>-->
		<script>
			 $(function() {
	...
	<div class="view ui-widget ui-widget-content ui-helper-clearfix ui-corner-all">
		...
		<div class="view-fields">	
			<ul class="droppable ui-sortable">
				...
				<li name="users_view@dateofbirth" class="ui-state-default ui-sortable-handle">
					...
					<input type="text" class="input-startdate text-field-name datepicker hasDatepicker" name="users_view@dateofbirth@input-startdate" id="dp1458984901550">
					<div class="sup-text-field-name">
						End Date 
					</div>
					<input type="text" class="input-enddate text-field-name datepicker hasDatepicker" name="users_view@dateofbirth@input-enddate" id="dp1458984901551">
				</li>
				...
				<li name="users_view@create_at" class="ui-state-default ui-sortable-handle">
					...
					<input type="text" class="input-startdate text-field-name datepicker hasDatepicker" name="users_view@create_at@input-startdate" id="dp1458984901552">
						<div class="sup-text-field-name">
							End Date 
						</div>
					<input type="text" class="input-enddate text-field-name datepicker hasDatepicker" name="users_view@create_at@input-enddate" id="dp1458984901553">
				</li>
				<li name="users_view@lastvisit_at" class="ui-state-default ui-sortable-handle">
					...
					<input type="text" class="input-startdate text-field-name datepicker hasDatepicker" name="users_view@lastvisit_at@input-startdate" id="dp1458984901554">
					<div class="sup-text-field-name">
						End Date 
					</div>
					<input type="text" class="input-enddate text-field-name datepicker hasDatepicker" name="users_view@lastvisit_at@input-enddate" id="dp1458984901555">
				</li>
		...
		<div class="view ui-widget ui-widget-content ui-helper-clearfix ui-corner-all">
			...
			<ul class="droppable ui-sortable">
				...
				<li name="users_addresses@dateofbirth" class="ui-state-default ui-sortable-handle">
					...
					<input type="text" class="input-startdate text-field-name datepicker hasDatepicker" name="users_addresses@dateofbirth@input-startdate" id="dp1458984901556">
					<div class="sup-text-field-name">
						End Date 
					</div>
					<input type="text" class="input-enddate text-field-name datepicker hasDatepicker" name="users_addresses@dateofbirth@input-enddate" id="dp1458984901557">
				</li>
		...
		<div class="view ui-widget ui-widget-content ui-helper-clearfix ui-corner-all"><div class="view-header ui-sortable-handle ui-widget-header ui-corner-all"><span class="ui-icon ui-icon-plusthick view-toggle"></span>User Events </div><div class="view-fields">	<ul class="droppable ui-sortable"><li name="users_events@id" class="ui-state-default ui-sortable-handle">id<input type="text" class="input-int text-field-name" name="users_events@id@input-int"></li><li name="users_events@title" class="ui-state-default ui-sortable-handle">title<input type="text" class="input-varchar text-field-name" name="users_events@title@input-varchar"></li><li name="users_events@tracker" class="ui-state-default ui-sortable-handle">tracker<input type="text" class="input-single-char text-field-name" name="users_events@tracker@input-single-char"></li><li name="users_events@start" class="ui-state-default ui-sortable-handle">start<div class="sup-text-field-name">Start Date </div><input type="text" class="input-startdate text-field-name datepicker hasDatepicker" name="users_events@start@input-startdate" id="dp1458984901558"><div class="sup-text-field-name">End Date </div><input type="text" class="input-enddate text-field-name datepicker hasDatepicker" name="users_events@start@input-enddate" id="dp1458984901559"></li><li name="users_events@end" class="ui-state-default ui-sortable-handle">end<div class="sup-text-field-name">Start Date </div><input type="text" class="input-startdate text-field-name datepicker hasDatepicker" name="users_events@end@input-startdate" id="dp1458984901560"><div class="sup-text-field-name">End Date </div><input type="text" class="input-enddate text-field-name datepicker hasDatepicker" name="users_events@end@input-enddate" id="dp1458984901561"></li><li name="users_events@editable" class="ui-state-default ui-sortable-handle">editable<input type="text" class="input-single-char text-field-name" name="users_events@editable@input-single-char"></li><li name="users_events@userid" class="ui-state-default ui-sortable-handle">userid<input type="text" class="input-int text-field-name" name="users_events@userid@input-int"></li><li name="users_events@firstname" class="ui-state-default ui-sortable-handle">firstname<input type="text" class="input-varchar text-field-name" name="users_events@firstname@input-varchar"></li><li name="users_events@lastname" class="ui-state-default ui-sortable-handle">lastname<input type="text" class="input-varchar text-field-name" name="users_events@lastname@input-varchar"></li><li name="users_events@dateofbirth" class="ui-state-default ui-sortable-handle">dateofbirth<div class="sup-text-field-name">Start Date </div><input type="text" class="input-startdate text-field-name datepicker hasDatepicker" name="users_events@dateofbirth@input-startdate" id="dp1458984901562"><div class="sup-text-field-name">End Date </div><input type="text" class="input-enddate text-field-name datepicker hasDatepicker" name="users_events@dateofbirth@input-enddate" id="dp1458984901563"></li><li name="users_events@email" class="ui-state-default ui-sortable-handle">email<input type="text" class="input-varchar text-field-name" name="users_events@email@input-varchar"></li><li name="users_events@companyid" class="ui-state-default ui-sortable-handle">companyid<input type="text" class="input-int text-field-name" name="users_events@companyid@input-int"></li><li name="users_events@primaryAddressTag" class="ui-state-default ui-sortable-handle">primaryAddressTag<input type="text" class="input-varchar text-field-name" name="users_events@primaryAddressTag@input-varchar"></li><li name="users_events@phonenumber" class="ui-state-default ui-sortable-handle">phonenumber<input type="text" class="input-varchar text-field-name" name="users_events@phonenumber@input-varchar"></li>	</ul></div></div>
